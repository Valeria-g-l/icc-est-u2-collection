...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Set<String> treeSetComp = setsClase.construirTreeSetConComparador();
        System.out.println(treeSetComp);
    ...
    private static void runMaquina(){
        ...
        Set<Maquina> maquinas0 = controller.ordenarPorSubred(maquinas);
